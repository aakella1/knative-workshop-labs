...
| [hey is accessible at the command line](didact://?commandId=vscode.didact.requirementCheck&text=hey-requirements-status$$hey%20123$$flag%Summary&completion=hey%20is%20available%20on%20this%20system. "Tests to see if `hey --version` returns a result"){.didact} 	| *Status: unknown*{#hey-requirements-status} hey is required	| See [Installing hey](https://github.com/rakyll/hey "brew install hey") and then restart VS Code
